    ...
    return (
        ...
        >
          ...
          <Modal.Body className="bg-dark text-white">
            <form className="w-100 new-monitor-form">
                
                <div className="new-monitor-form-group">
                    <label className="control-label">Name</label>
                    <div className="col-12">
                        <input id="new-monior-name" type="text" className="form-control" placeholder="Monitor name" />
                    </div>
                </div>
                ...
                <div className="new-monitor-form-group">
                    ...
                    <div className="col-12">
                        <select id="new-monitor-interval" className="form-control">
                ...
                <div className="row w-100">
                    <div className="col-6 p-0">
                        <div className="new-monitor-form-group w-90">
                            ...
                            <div className="col-12">
                                <input id="new-monitor-min-attemps-to-down" type="number" className="form-control" placeholder="3" min={1} max={10} value={3} />
                            </div>
                        </div>
                    </div>
                    <div className="col-6 p-0">
                        <div className="new-monitor-form-group w-90">
                            ...
                            <div className="col-12">
                                <input id="new-monitor-max-redirects" type="number" className="form-control" placeholder="3" min={1} max={10} value={3} />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="row w-100">
                    <div className="col-6 p-0">
                        <div className="new-monitor-form-group w-90">
                            ...
                            <div className="col-12">
                                <input id="new-monitor-min-acceptable-status-code" type="number" className="form-control" placeholder="200" min={1} max={500} value={200} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-6 p-0">
                        <div className="new-monitor-form-group w-90">
                            ...
                            <div className="col-12">
                                <input id="new-monitor-max-acceptable-status-code" type="number" className="form-control" placeholder="299" min={1} max={500} value={299} />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="row w-100">
                    <div className="col-6 p-0">
                        <div className="new-monitor-form-group w-90">
                            ...
                            <div className="col-12">
                                <select id="new-monior-type" className="form-control">
                    ...
                    <div className="col-6 p-0">
                        <div className="new-monitor-form-group w-90">
                            ...
                            <div className="col-12">
                                <select id="new-monitor-method" className="form-control">
                ...
                <button id="new-monitor-submit" type="button" className="btn btn-success w-100 mt-3">
                    Create
                </button>
